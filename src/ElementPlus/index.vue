  ...
  >
    ...
    <div ref="wrapperRef" :class="wrapperKls">
      ...
      <DoNotRemember
        ...
        @input="(_, event) => handleInput(event)"
        @focus="handleFocus"
        @blur="handleBlur"
        @change="(_, event) => handleChange(event)"
      ...
      <span v-if="suffixVisible" :class="nsInput.e('suffix')">
        <span :class="nsInput.e('suffix-inner')">
          ...
          <span v-if="isWordLimitVisible" :class="nsInput.e('count')">
            <span :class="nsInput.e('count-inner')"> {{ textLength }} / {{ maxlength }} </span>
          </span>
          <el-icon
...
import { CHANGE_EVENT, INPUT_EVENT, UPDATE_MODEL_EVENT } from 'element-plus/es/constants/index.mjs'
import { calcTextareaHeight } from 'element-plus/es/components/input/src/utils.mjs'
import { inputEmits, inputProps } from 'element-plus/es/components/input/src/input.mjs'
